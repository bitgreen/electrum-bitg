...
This guide explains how to build Electrum-BITG binaries for macOS systems.
...
#### 2. Build Electrum-BITG

    cd electrum-bitg
    ./contrib/osx/make_osx

This creates both a folder named Electrum-BITG.app and the .dmg file.
