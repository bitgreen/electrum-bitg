...
exe_standalone = EXE(
    ...
    a.binaries,
    a.datas,
    name=os.path.join('build\\pyi.win32\\electrum-bitg', cmdline_name + ".exe"),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'electrum/gui/icons/electrum.ico',
    console=False)
    # console=True makes an annoying black box pop up, but it does make Electrum-BITG output command line commands, with this turned off no output will be given but commands can still be used
...
exe_portable = EXE(
    ...
    name=os.path.join('build\\pyi.win32\\electrum-bitg', cmdline_name + "-portable.exe"),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'electrum/gui/icons/electrum.ico',
...
exe_dependent = EXE(
    ...
    name=os.path.join('build\\pyi.win32\\electrum-bitg', cmdline_name),
    debug=False,
    strip=None,
    upx=False,
    icon=home+'electrum/gui/icons/electrum.ico',
...
coll = COLLECT(
    ...
    icon=home+'electrum/gui/icons/electrum.ico',
    console=False,
    name=os.path.join('dist', 'electrum-bitg'))
