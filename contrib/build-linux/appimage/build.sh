...
APPDIR="$BUILDDIR/electrum-bitg.AppDir"
...
APPIMAGE="$DISTDIR/electrum-bitg-$VERSION-x86_64.AppImage"
...
info "installing electrum-bitg and its dependencies."
...
cp "$PROJECT_ROOT/electrum-bitg.desktop" "$APPDIR/electrum-bitg.desktop"
